...
Revision ID: 25a5672fbab9
Revises: 
Create Date: 2025-04-28 10:56:27.306797
...
def upgrade():
    ...
    sa.CheckConstraint('full_amount > 0 AND invested_amount >= 0 AND invested_amount <= full_amount', name='check_full_and_invested_amounts'),
